...
func AddKubeletConfigFlags(fs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.StringVar(&c.CPUPoolsConfig, "cpu-pools", "", "A set of CPU to pool assignments, for the 'pooled' CPU manager policy, in the form of {\"poolname0\":{\"cpuset\": \"pool0cpu0-pool0cpu1\"},\"poolname1\":{\"cpuset\":\"pool1cpu2,pool1cpu3\"}}. This is used to split up the available CPUs/cores to named pools. There is no default setting for this option.")
}
